...
export default function PomodoroPage() {
  ...
  const [tasks, setTasks] = useState([
    { id: 1, text: 'Review Mathematics homework problems', completed: false },
    { id: 2, text: 'Read Biology chapter summaries', completed: false },
  ]);
  ...
  return (
    <div className="flex flex-col min-h-screen">
      <Navbar />
      <div className="flex-1 max-w-5xl mx-auto w-full p-6 md:p-8 grid grid-cols-1 md:grid-cols-12 gap-8 items-start">
                ...
                <AnimatePresence>
                  {tasks.map((task) => (
                    <motion.div
                      ...
                      className={`flex items-center gap-3 p-3 rounded-xl border border-white/5 bg-white/[0.01] hover:border-white/10 cursor-pointer transition-all ${
